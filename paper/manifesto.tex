...
\author{
  Developmental Physics AI Project\\
  \texttt{dev-physics-ai@example.org}
}
...
\begin{abstract}
We argue that contemporary artificial intelligence systems lack the {\em core knowledge} that human infants possess: an intuitive understanding of objects, agents, forces, space, and time. We propose a developmental approach to machine learning in which an artificial agent learns physics through raw, unstructured sensory interaction with simulated environments. By combining the angle geometry of angle-nets with the physics constraints of UGCT, and guided by principles of predictive coding and active inference, we outline a four-stage developmental curriculum: sensorimotor learning, intuitive physics, intuitive psychology, and symbolic reasoning. We further connect this proposal to foundational work in developmental psychology and argue that a curriculum grounded in physical interaction is a necessary condition for robust, generalizable intelligence.
\end{abstract}
...
Anonymous.
\newblock Angle geometry in neural network representations.
\newblock \emph{In preparation}, 2023.

\bibitem{ ugct2023 }
Anonymous.
\newblock Universal geometry-constrained training for physical reasoning.
\newblock \emph{In preparation}, 2023.
